...
def preprocess_abstract(abstract: str, datapath: str) -> str:
    mappings = load_unicode_mappings(datapath)
    return normalize_whitespace(
        remove_brackets(remove_angles(unicode2ascii(mappings, abstract)))
    )
