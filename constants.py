...
PATTERNS_NEUTRAL_RELATIONS = [
    [
        ...
        {"POS": "VERB", "LEMMA": "associate"},
        {"POS": "ADP", "LEMMA": "with"},
    ]
]
PATTERNS_NEGATION = [[{"DEP": "neg"}], [{"LOWER": "not"}]]
...
ACCEPTED_CATEGORIES = {
    ...
    # Vitamin, ex.: 5,25-Dihydroxy cholecalciferol; alpha-tocopheryl oxalate; Vitamin A [EPC]
    "T127",
}
