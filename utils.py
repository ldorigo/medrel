...
DATALOCATION_WIDGET = widgets.Text(value="data", description="Data location:")
SESSIONLOCATION_WIDGET = widgets.Text(
    value="small_subset", description="Session location:")
QUICKUMLS_LOCATION_WIDGET = widgets.Text(
    value="/Users/ldorigo/Documents/QuickUMLS_caps", description="QuickUMLS path:")

MRCONSO_PATH = "/Users/ldorigo/Documents/UMLS/Documents/2018AB/META/MRCONSO.pipe"
...
def load_if_not_present(variable: Optional[pandas.DataFrame], name: str) -> pandas.DataFrame:
    ...
    if variable is None:
        ...
        logger.debug("Loaded {} from csv.".format(name))
